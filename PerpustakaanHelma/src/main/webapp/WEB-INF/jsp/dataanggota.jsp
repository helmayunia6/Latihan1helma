...
<head>
    ...
    <title>Data Anggota - Perpustakaan Helma</title>
...
<section id="container">
    ...
    <section id="main-content">
        <section class="wrapper">
            <h3><i class="fa fa-angle-right"></i>DATA ANGGOTA</h3>
            <div class="row mb" style="padding:20px;">
                ...
                <div class="content-panel" style="padding:10px;">
                    ...
                    <button class="btn btn-theme" type="submit"><a href="${tambahanggota}">Tambah Anggota</a></button>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                            ...
                            <c:forEach var="anggota" items="${anggota}">
                                <tr>
                                    ...
                                    <td><img src="image/.${anggota.foto}.style="width="200px";height="200px;"></td>

                                    <td>
                                        <c:url var="update" value="/doUpdateDataAnggota">
                                            <c:param name="id_anggota" value="${anggota.id_anggota}"/>
                                        </c:url>
                                        <a href="${update}" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i> Ubah</a>

                                        <c:url var="hapus" value="/deletedataanggota">
                                            <c:param name="id_anggota" value="${anggota.id_anggota}"/>
                                        </c:url>
