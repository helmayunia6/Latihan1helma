...
<head>
    ...
    <title>Data Pengembalian - Perpustakaan Helma</title>
...
<section id="container">
        ...
        <div id="sidebar" class="nav-collapse ">
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <a class="active" href="${datapengembalian}">
                        <i class="fa fa-book"></i>
    ...
    <section id="main-content">
        <section class="wrapper">
            <h3><i class="fa fa-angle-right"></i>DATA PENGEMBALIAN BUKU</h3>
...
<%--                    <button class="btn btn-theme" type="submit"><a href="${tambahanggota}">Refresh</a></button>--%>
                    ...
                    <div class="adv-table">
                        <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                            ...
                            <tbody>
                            <c:forEach var="kembali" items="${kembali}">
                                <tr>
                                    <td>${kembali.kd_kembali}</td>
                                    <td>${kembali.kd_pinjam}</td>
                                    <td>${kembali.id_anggota}</td>
