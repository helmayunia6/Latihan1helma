...
<head>
    ...
    <title>Tambah Buku - Perpustakaan Helma</title>
...
<section id="container">
    ...
    <section id="main-content">
        <section class="wrapper">
            <h3><i class="fa fa-angle-right"></i>FORM TAMBAH BUKU</h3>

            <div class="form-panel">
                <div class="form">
                    <form:form  id="buku" action="/saveBuku" modelAttribute="bukuDTO" method="POST"  class="cmxform form-horizontal style-form">
                        <div class="form-group ">
                            <label for="kd_buku" class="control-label col-lg-2">Kode Buku</label>
                            <div class="col-lg-10">
                                <input name="kd_buku" class="form-control" path="kd_buku" type="text" />
                            </div>
                        </div>
                        <div class="form-group ">
                            <label for="judul_buku" class="control-label col-lg-2">Judul Buku</label>
                            <div class="col-lg-10">
                                <input name="judul_buku" class="form-control" path="judul_buku" type="text" />
                            </div>
                        </div>
                        <div class="form-group ">
                            <label for="penerbit_buku" class="control-label col-lg-2">Penerbit Buku</label>
                            <div class="col-lg-10">
                                <input name="penerbit_buku" class="form-control" path="penerbit_buku" type="text" />
                            </div>
                        </div>
                        <div class="form-group ">
                            <label for="tahun_terbit" class="control-label col-lg-2">Tahun Terbit</label>
                            <div class="col-lg-10">
                                <input name="tahun_terbit" class="form-control" path="tahun_terbit" type="text" />
                            </div>
                        </div>
                        <div class="form-group ">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-lg-10">
                                <input name="jumlah" class="form-control" path="jumlah" type="text" />
                            </div>
                        </div>
