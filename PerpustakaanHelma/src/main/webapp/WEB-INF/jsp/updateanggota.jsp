...
<head>
    ...
    <title>Edit Anggota - Perpustakaan Helma</title>
...
<section id="container">
    ...
    <section id="main-content">
        <section class="wrapper">
            <h3><i class="fa fa-angle-right"></i>FORM UPDATE ANGGOTA</h3>

            <div class="form-panel">
                <div class="form">
                    <form:form  id="anggota" action="/updateAnggota" modelAttribute="AnggotaDTO" method="POST"  class="cmxform form-horizontal style-form">
                    <form:hidden path="id_anggota" value="${AnggotaDTO.id_anggota}" />
                    <div class="form-group ">
                        <label for="id_anggota" class="control-label col-lg-2">ID Anggota</label>
                        <div class="col-lg-10">
                            <input name="id_anggota" class="form-control" id="disabledInput" path="id_anggota" type="text" value="${AnggotaDTO.id_anggota}" disabled/>
                        </div>
                    </div>
                    <div class="form-group ">
                        <label for="nama_anggota" class="control-label col-lg-2">Nama Anggota</label>
                        <div class="col-lg-10">
                            <input name="nama_anggota" class="form-control" path="nama_anggota" type="text" value="${AnggotaDTO.nama_anggota}"/>
                        </div>
                    </div>
                        <div class="form-group ">
                            ...
                            <div>
                                <label>
                                    <select name="jenis_kelamin" class="form-control" id="jenis_kelamin" value="${AnggotaDTO.jenis_kelamin}" >
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-lg-10">
                                <input name="tempat_lahir" class="form-control" path="tempat_lahir" type="text" value="${AnggotaDTO.tempat_lahir}"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Tanggal Lahir</label>
                            <div class="col-md-3 col-xs-11">
                                <input name="tanggal_lahir" path="tanggal_lahir" class="form-control form-control-inline input-medium default-date-picker" size="16" type="text" value="${AnggotaDTO.tanggal_lahir}">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-lg-10">
                            <input name="alamat" class="form-control" path="alamat" type="text" value="${AnggotaDTO.alamat}"/>
                        </div>
                    </div>
                    <div class="form-group ">
                        <label for="jurusan" class="control-label col-lg-2">Jurusan</label>
                        <div class="col-lg-10">
                            <input name="jurusan" class="form-control" path="jurusan" type="text" value="${AnggotaDTO.jurusan}"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group last">
                            ...
                            <div class="col-md-9">
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                    ...
                                    <div>
                                        <input name="foto" path="foto" type="file" class="default" value="${AnggotaDTO.foto}"/>
                                    </div>
                                </div>
